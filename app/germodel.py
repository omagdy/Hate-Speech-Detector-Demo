...
with open('app/germeval/tokenizer.pickle', 'rb') as handle:
...
with open('app/germeval/i2t.pkl', 'rb') as handle:
  i2t = pickle.load(handle)

with open('app/germeval/t2i.pkl', 'rb') as handle:
  t2i = pickle.load(handle)

ger_model = keras.models.load_model('app/germeval/germevalcnn.model')
graph = tf.get_default_graph()

def analyze_ger_text(text):
